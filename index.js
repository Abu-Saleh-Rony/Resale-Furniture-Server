...
var uri = `mongodb://${process.env.DB_USER}:${process.env.DB_PASSWORD}@ac-4rd2pp4-shard-00-00.xtwoonc.mongodb.net:27017,ac-4rd2pp4-shard-00-01.xtwoonc.mongodb.net:27017,ac-4rd2pp4-shard-00-02.xtwoonc.mongodb.net:27017/?ssl=true&replicaSet=atlas-wltr6l-shard-0&authSource=admin&retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const productsCollection = client.db("resalefurniture").collection("furnitureProducts");
        const categoryCollection = client.db("resalefurniture").collection("category");
        ...
        const paymentsCollection = client.db("resalefurniture").collection("payment");
        const wishListCollection = client.db("resalefurniture").collection("wishList");
        const advertiseCollection = client.db("resalefurniture").collection("advertise");
        const reportCollection = client.db("resalefurniture").collection("report");
...
app.listen(port, () => console.log(`Resale Furniture portal running on ${port}`));
